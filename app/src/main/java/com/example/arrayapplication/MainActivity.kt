    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonAccount.setOnClickListener {
            try {
                ...
                Log.i("info_anado", existingAccount.toString())
                if(!existingAccount){
                ...
                Log.e("error_anado", e.message.toString())
            }
        }
        buttonUpdate.setOnClickListener {
            try {
                ...
                if(existingAccount >= 0 && existingPassword == editPassword.text.toString()){
                    ...
                    Log.i("info_anado", updateToastStatement)
                    textAccount.setText(arrayAccount.size.toString())
        ...
        buttonDelete.setOnClickListener {
            try {
                ...
                if(existingAccount >= 0 && existingPassword == editPassword.text.toString()){
                    ...
                    Log.i("info_anado", deleteToastStatement)
                    textAccount.setText(arrayAccount.size.toString())
